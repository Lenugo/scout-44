...
<figure className="m-0 md:w-full md:m-4">
...
<!-- <audio controls className='mx-auto my-6'>
  <source src='./dominican-anthem.mp3' type='audio/ogg' />
  <source src='./dominican-anthem.mp3' type='audio/mpeg' />
...
:::tip[Oración scout]
<strong style={{ display: "block", textAlign: "center" }}>Señor, <br />enséñame a ser generoso, <br />a servirte como lo mereces,<br />a dar sin medida,<br />a combatir sin temor a las heridas,<br />a trabajar sin descanso,<br />a no buscar más recompensa y<br />saber que hago por tu santa voluntad,<br />amén.</strong>
:::
